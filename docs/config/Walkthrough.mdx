...
-- Example : table 1 has  {"python", "java", "c++"} and table 2 has {"lua"}, now you might be wondering that it should merge it like this : 

-- { "python", "java", "c++", "lua"} , But no! thats wrong, the result will be only {"lua"}.
```
<br/>
