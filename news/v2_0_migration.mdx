...
## Removed commands & mappings
 ...
 Some mappings and commands have been removed. However their functions still exist, just make your own commands/mappings for them. Read our [api functions docs](http://localhost:3000/#/docs/api).
