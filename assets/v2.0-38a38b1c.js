...
`]}}),f,pe),l(i,n(e.p,{get children(){return n(e.img,{src:"/features/nvdash.webp",alt:"nvdash"})}}),v,fe),l(i,n(e.h2,{children:"New cmp styles"}),x,xe),l(i,n(e.ul,{get children(){return[`
...
`]}}),en,nn),i})()}function sn(r={}){const{wrapper:e}=Object.assign({},B(),r.components);return e?n(e,tn(r,{get children(){return n(q,r)}})):q(r)}const hn=Object.freeze(Object.defineProperty({__proto__:null,default:sn,meta:an},Symbol.toStringTag,{value:"Module"}));export{hn as _};
