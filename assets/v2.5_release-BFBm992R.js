...
`,n(e.li,{get children(){return[t(d,i())," is the command"]}}),`
`]}}),`
...
`]}})]}function m(r={}){const{wrapper:e}={...l(),...r.components};return e?n(e,o(r,{get children(){return n(h,r)}})):h(r)}const y=Object.freeze(Object.defineProperty({__proto__:null,default:m,meta:g},Symbol.toStringTag,{value:"Module"}));var p=["<br",">"];const f={title:"NvChad v2.5 released!",desc:"Minor NvChad release with standard neovim config structure, new 11 themes, UI Term module replacing nvterm.",cover:"v2.5.webp"};function c(r){const e={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...r.components};return[n(e.h1,{children:"NvChad v2.5 Released!"}),`
