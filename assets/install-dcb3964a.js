import{c as x,e as k,g as d,a as s,i as n,b as g,h as L,t as v,f as u,d as D,r as M}from"./entry-client-99d97252.js";const P=v("<button><div text-base></div><!#><!/>"),O=v('<div grid gap-5><div flex flex-wrap class="[&amp;_button]:p-3" gap-3><!#><!/><!#><!/><!#><!/></div><!#><!/>'),b=v('<pre class="hljs">'),[R,y]=x("Linux / Macos"),C="git clone https://github.com/NvChad/NvChad ~/.config/nvim --depth 1 && nvim",U=[`# if you're using Command Prompt(CMD) 
