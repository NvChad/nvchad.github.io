...
`]}}),`
`]}}),a,B),l(i,n(e.h2,{children:"Lazy.nvim"}),o,P),l(i,n(e.ul,{get children(){return[`
...
`]}}),h,q),l(i,n(e.pre,{get children(){return n(e.code,{className:"hljs language-lua",get children(){return[n(e.span,{className:"hljs-comment",children:"--  before "}),`
...
`]}}),Ne,ye),i})()}function Te(r={}){const{wrapper:e}=Object.assign({},z(),r.components);return e?n(e,je(r,{get children(){return n(T,r)}})):T(r)}const Re=Object.freeze(Object.defineProperty({__proto__:null,default:Te,meta:Ce},Symbol.toStringTag,{value:"Module"}));export{Re as _};
