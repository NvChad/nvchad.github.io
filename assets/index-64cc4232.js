(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))l(s);new MutationObserver(s=>{for(const c of s)if(c.type==="childList")for(const o of c.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&l(o)}).observe(document,{childList:!0,subtree:!0});function i(s){const c={};return s.integrity&&(c.integrity=s.integrity),s.referrerPolicy&&(c.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?c.credentials="include":s.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function l(s){if(s.ep)return;s.ep=!0;const c=i(s);fetch(s.href,c)}})();const j={};function $e(t){j.context=t}function _t(){return{...j.context,id:`${j.context.id}${j.context.count++}-`,count:0}}const gt=(t,e)=>t===e,R=Symbol("solid-proxy"),ln=Symbol("solid-track"),ft=Symbol("solid-dev-component"),be={equals:gt};let In=zn;const z=1,ve=2,Dn={owned:null,cleanups:null,context:null,owner:null};var y=null;let B=null,v=null,P=null,C=null,Le=0;function Rn(t,e){const i=v,l=y,s=t.length===0,c=s?Dn:{owned:null,cleanups:null,context:null,owner:e===void 0?l:e},o=s?t:()=>t(()=>$(()=>xe(c)));y=c,v=null;try{return q(o,!0)}finally{v=i,y=l}}function L(t,e){e=e?Object.assign({},be,e):be;const i={value:t,observers:null,observerSlots:null,comparator:e.equals||void 0},l=s=>(typeof s=="function"&&(s=s(i.value)),Mn(i,s));return[Sn.bind(i),l]}function E(t,e,i){const l=He(t,e,!1,z);de(l)}function Be(t,e,i){In=Et;const l=He(t,e,!1,z);l.user=!0,C?C.push(l):de(l)}function b(t,e,i){i=i?Object.assign({},be,i):be;const l=He(t,e,!0,0);return l.observers=null,l.observerSlots=null,l.comparator=i.equals||void 0,de(l),Sn.bind(l)}function bt(t){return q(t,!1)}function $(t){if(v===null)return t();const e=v;v=null;try{return t()}finally{v=e}}function Ue(t,e,i){const l=Array.isArray(t);let s,c=i&&i.defer;return o=>{let h;if(l){h=Array(t.length);for(let d=0;d<t.length;d++)h[d]=t[d]()}else h=t();if(c){c=!1;return}const u=$(()=>e(h,s,o));return s=h,u}}function $n(t){Be(()=>$(t))}function Te(t){return y===null||(y.cleanups===null?y.cleanups=[t]:y.cleanups.push(t)),t}function Cn(){return v}function vt(){return y}function wt(t,e){const i=y,l=v;y=t,v=null;try{return q(e,!0)}catch(s){We(s)}finally{y=i,v=l}}function yt(t){const e=v,i=y;return Promise.resolve().then(()=>{v=e,y=i;let l;return q(t,!1),v=y=null,l?l.done:void 0})}function Vn(t,e){const i=Symbol("context");return{id:i,Provider:At(i),defaultValue:t}}function Fe(t){let e;return(e=Bn(y,t.id))!==void 0?e:t.defaultValue}function Xe(t){const e=b(t),i=b(()=>Ce(e()));return i.toArray=()=>{const l=i();return Array.isArray(l)?l:l!=null?[l]:[]},i}function Sn(){const t=B;if(this.sources&&(this.state||t))if(this.state===z||t)de(this);else{const e=P;P=null,q(()=>ye(this),!1),P=e}if(v){const e=this.observers?this.observers.length:0;v.sources?(v.sources.push(this),v.sourceSlots.push(e)):(v.sources=[this],v.sourceSlots=[e]),this.observers?(this.observers.push(v),this.observerSlots.push(v.sources.length-1)):(this.observers=[v],this.observerSlots=[v.sources.length-1])}return this.value}function Mn(t,e,i){let l=t.value;return(!t.comparator||!t.comparator(l,e))&&(t.value=e,t.observers&&t.observers.length&&q(()=>{for(let s=0;s<t.observers.length;s+=1){const c=t.observers[s],o=B&&B.running;o&&B.disposed.has(c),(o&&!c.tState||!o&&!c.state)&&(c.pure?P.push(c):C.push(c),c.observers&&qn(c)),o||(c.state=z)}if(P.length>1e6)throw P=[],new Error},!1)),e}function de(t){if(!t.fn)return;xe(t);const e=y,i=v,l=Le;v=y=t,Nt(t,t.value,l),v=i,y=e}function Nt(t,e,i){let l;try{l=t.fn(e)}catch(s){return t.pure&&(t.state=z,t.owned&&t.owned.forEach(xe),t.owned=null),t.updatedAt=i+1,We(s)}(!t.updatedAt||t.updatedAt<=i)&&(t.updatedAt!=null&&"observers"in t?Mn(t,l):t.value=l,t.updatedAt=i)}function He(t,e,i,l=z,s){const c={fn:t,state:l,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:e,owner:y,context:null,pure:i};return y===null||y!==Dn&&(y.owned?y.owned.push(c):y.owned=[c]),c}function we(t){const e=B;if(t.state===0||e)return;if(t.state===ve||e)return ye(t);if(t.suspense&&$(t.suspense.inFallback))return t.suspense.effects.push(t);const i=[t];for(;(t=t.owner)&&(!t.updatedAt||t.updatedAt<Le);)(t.state||e)&&i.push(t);for(let l=i.length-1;l>=0;l--)if(t=i[l],t.state===z||e)de(t);else if(t.state===ve||e){const s=P;P=null,q(()=>ye(t,i[0]),!1),P=s}}function q(t,e){if(P)return t();let i=!1;e||(P=[]),C?i=!0:C=[],Le++;try{const l=t();return jt(i),l}catch(l){i||(C=null),P=null,We(l)}}function jt(t){if(P&&(zn(P),P=null),t)return;const e=C;C=null,e.length&&q(()=>In(e),!1)}function zn(t){for(let e=0;e<t.length;e++)we(t[e])}function Et(t){let e,i=0;for(e=0;e<t.length;e++){const l=t[e];l.user?t[i++]=l:we(l)}for(j.context&&$e(),e=0;e<i;e++)we(t[e])}function ye(t,e){const i=B;t.state=0;for(let l=0;l<t.sources.length;l+=1){const s=t.sources[l];s.sources&&(s.state===z||i?s!==e&&(!s.updatedAt||s.updatedAt<Le)&&we(s):(s.state===ve||i)&&ye(s,e))}}function qn(t){const e=B;for(let i=0;i<t.observers.length;i+=1){const l=t.observers[i];(!l.state||e)&&(l.state=ve,l.pure?P.push(l):C.push(l),l.observers&&qn(l))}}function xe(t){let e;if(t.sources)for(;t.sources.length;){const i=t.sources.pop(),l=t.sourceSlots.pop(),s=i.observers;if(s&&s.length){const c=s.pop(),o=i.observerSlots.pop();l<s.length&&(c.sourceSlots[o]=l,s[l]=c,i.observerSlots[l]=o)}}if(t.owned){for(e=0;e<t.owned.length;e++)xe(t.owned[e]);t.owned=null}if(t.cleanups){for(e=0;e<t.cleanups.length;e++)t.cleanups[e]();t.cleanups=null}t.state=0,t.context=null}function kt(t){return t instanceof Error||typeof t=="string"?t:new Error("Unknown error")}function We(t){throw t=kt(t),t}function Bn(t,e){return t?t.context&&t.context[e]!==void 0?t.context[e]:Bn(t.owner,e):void 0}function Ce(t){if(typeof t=="function"&&!t.length)return Ce(t());if(Array.isArray(t)){const e=[];for(let i=0;i<t.length;i++){const l=Ce(t[i]);Array.isArray(l)?e.push.apply(e,l):e.push(l)}return e}return t}function At(t,e){return function(l){let s;return E(()=>s=$(()=>(y.context={[t]:l.value},Xe(()=>l.children))),void 0),s}}let Lt=!1;function p(t,e){if(Lt&&j.context){const i=j.context;$e(_t());const l=$(()=>t(e||{}));return $e(i),l}return $(()=>t(e||{}))}function _e(){return!0}const Ve={get(t,e,i){return e===R?i:t.get(e)},has(t,e){return e===R?!0:t.has(e)},set:_e,deleteProperty:_e,getOwnPropertyDescriptor(t,e){return{configurable:!0,enumerable:!0,get(){return t.get(e)},set:_e,deleteProperty:_e}},ownKeys(t){return t.keys()}};function Ie(t){return(t=typeof t=="function"?t():t)?t:{}}function Ne(...t){let e=!1;for(let l=0;l<t.length;l++){const s=t[l];e=e||!!s&&R in s,t[l]=typeof s=="function"?(e=!0,b(s)):s}if(e)return new Proxy({get(l){for(let s=t.length-1;s>=0;s--){const c=Ie(t[s])[l];if(c!==void 0)return c}},has(l){for(let s=t.length-1;s>=0;s--)if(l in Ie(t[s]))return!0;return!1},keys(){const l=[];for(let s=0;s<t.length;s++)l.push(...Object.keys(Ie(t[s])));return[...new Set(l)]}},Ve);const i={};for(let l=t.length-1;l>=0;l--)if(t[l]){const s=Object.getOwnPropertyDescriptors(t[l]);for(const c in s)c in i||Object.defineProperty(i,c,{enumerable:!0,get(){for(let o=t.length-1;o>=0;o--){const h=(t[o]||{})[c];if(h!==void 0)return h}}})}return i}function Un(t,...e){const i=new Set(e.flat());if(R in t){const s=e.map(c=>new Proxy({get(o){return c.includes(o)?t[o]:void 0},has(o){return c.includes(o)&&o in t},keys(){return c.filter(o=>o in t)}},Ve));return s.push(new Proxy({get(c){return i.has(c)?void 0:t[c]},has(c){return i.has(c)?!1:c in t},keys(){return Object.keys(t).filter(c=>!i.has(c))}},Ve)),s}const l=Object.getOwnPropertyDescriptors(t);return e.push(Object.keys(l).filter(s=>!i.has(s))),e.map(s=>{const c={};for(let o=0;o<s.length;o++){const h=s[o];h in t&&Object.defineProperty(c,h,l[h]?l[h]:{get(){return t[h]},set(){return!0},enumerable:!0})}return c})}function Ge(t){let e=!1;const i=t.keyed,l=b(()=>t.when,void 0,{equals:(s,c)=>e?s===c:!s==!c});return b(()=>{const s=l();if(s){const c=t.children,o=typeof c=="function"&&c.length>0;return e=i||o,o?$(()=>c(s)):c}return t.fallback},void 0,void 0)}const Tt=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","disabled","formnovalidate","hidden","indeterminate","ismap","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","seamless","selected"],xt=new Set(["className","value","readOnly","formNoValidate","isMap","noModule","playsInline",...Tt]),Ot=new Set(["innerHTML","textContent","innerText","children"]),Pt=Object.assign(Object.create(null),{className:"class",htmlFor:"for"}),sn=Object.assign(Object.create(null),{class:"className",formnovalidate:"formNoValidate",ismap:"isMap",nomodule:"noModule",playsinline:"playsInline",readonly:"readOnly"}),It=new Set(["beforeinput","click","dblclick","contextmenu","focusin","focusout","input","keydown","keyup","mousedown","mousemove","mouseout","mouseover","mouseup","pointerdown","pointermove","pointerout","pointerover","pointerup","touchend","touchmove","touchstart"]),Dt=new Set(["altGlyph","altGlyphDef","altGlyphItem","animate","animateColor","animateMotion","animateTransform","circle","clipPath","color-profile","cursor","defs","desc","ellipse","feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence","filter","font","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignObject","g","glyph","glyphRef","hkern","image","line","linearGradient","marker","mask","metadata","missing-glyph","mpath","path","pattern","polygon","polyline","radialGradient","rect","set","stop","svg","switch","symbol","text","textPath","tref","tspan","use","view","vkern"]),Rt={xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace"};function $t(t,e,i){let l=i.length,s=e.length,c=l,o=0,h=0,u=e[s-1].nextSibling,d=null;for(;o<s||h<c;){if(e[o]===i[h]){o++,h++;continue}for(;e[s-1]===i[c-1];)s--,c--;if(s===o){const m=c<l?h?i[h-1].nextSibling:i[c-h]:u;for(;h<c;)t.insertBefore(i[h++],m)}else if(c===h)for(;o<s;)(!d||!d.has(e[o]))&&e[o].remove(),o++;else if(e[o]===i[c-1]&&i[h]===e[s-1]){const m=e[--s].nextSibling;t.insertBefore(i[h++],e[o++].nextSibling),t.insertBefore(i[--c],m),e[s]=i[c]}else{if(!d){d=new Map;let f=h;for(;f<c;)d.set(i[f],f++)}const m=d.get(e[o]);if(m!=null)if(h<m&&m<c){let f=o,A=1,x;for(;++f<s&&f<c&&!((x=d.get(e[f]))==null||x!==m+A);)A++;if(A>m-h){const k=e[o];for(;h<m;)t.insertBefore(i[h++],k)}else t.replaceChild(i[h++],e[o++])}else o++;else e[o++].remove()}}}const rn="_$DX_DELEGATE";function Ct(t,e,i,l={}){let s;return Rn(c=>{s=c,e===document?t():_(e,t(),e.firstChild?null:void 0,i)},l.owner),()=>{s(),e.textContent=""}}function g(t,e,i){const l=document.createElement("template");if(l.innerHTML=t,e&&l.innerHTML.split("<").length-1!==e)throw`The browser resolved template HTML does not match JSX input:
${l.innerHTML}

${t}. Is your HTML properly formed?`;let s=l.content.firstChild;return i&&(s=s.firstChild),s}function F(t,e=window.document){const i=e[rn]||(e[rn]=new Set);for(let l=0,s=t.length;l<s;l++){const c=t[l];i.has(c)||(i.add(c),e.addEventListener(c,Ft))}}function V(t,e,i){i==null?t.removeAttribute(e):t.setAttribute(e,i)}function Vt(t,e,i,l){l==null?t.removeAttributeNS(e,i):t.setAttributeNS(e,i,l)}function I(t,e){e==null?t.removeAttribute("class"):t.className=e}function St(t,e,i,l){if(l)Array.isArray(i)?(t[`$$${e}`]=i[0],t[`$$${e}Data`]=i[1]):t[`$$${e}`]=i;else if(Array.isArray(i)){const s=i[0];t.addEventListener(e,i[0]=c=>s.call(t,i[1],c))}else t.addEventListener(e,i)}function Mt(t,e,i={}){const l=Object.keys(e||{}),s=Object.keys(i);let c,o;for(c=0,o=s.length;c<o;c++){const h=s[c];!h||h==="undefined"||e[h]||(an(t,h,!1),delete i[h])}for(c=0,o=l.length;c<o;c++){const h=l[c],u=!!e[h];!h||h==="undefined"||i[h]===u||!u||(an(t,h,!0),i[h]=u)}return i}function zt(t,e,i){if(!e)return i?V(t,"style"):e;const l=t.style;if(typeof e=="string")return l.cssText=e;typeof i=="string"&&(l.cssText=i=void 0),i||(i={}),e||(e={});let s,c;for(c in i)e[c]==null&&l.removeProperty(c),delete i[c];for(c in e)s=e[c],s!==i[c]&&(l.setProperty(c,s),i[c]=s);return i}function Fn(t,e={},i,l){const s={};return l||E(()=>s.children=K(t,e.children,s.children)),E(()=>e.ref&&e.ref(t)),E(()=>qt(t,e,i,!0,s,!0)),s}function _(t,e,i,l){if(i!==void 0&&!l&&(l=[]),typeof e!="function")return K(t,e,l,i);E(s=>K(t,e(),s,i),l)}function qt(t,e,i,l,s={},c=!1){e||(e={});for(const o in s)if(!(o in e)){if(o==="children")continue;s[o]=cn(t,o,null,s[o],i,c)}for(const o in e){if(o==="children"){l||K(t,e.children);continue}const h=e[o];s[o]=cn(t,o,h,s[o],i,c)}}function Bt(t){let e,i;if(!j.context||!(e=j.registry.get(i=Xt()))){if(j.context&&console.warn("Unable to find DOM nodes for hydration key:",i),!t)throw new Error("Unrecoverable Hydration Mismatch. No template for key: "+i);return t.cloneNode(!0)}return j.completed&&j.completed.add(e),j.registry.delete(i),e}function Ut(t){return t.toLowerCase().replace(/-([a-z])/g,(e,i)=>i.toUpperCase())}function an(t,e,i){const l=e.trim().split(/\s+/);for(let s=0,c=l.length;s<c;s++)t.classList.toggle(l[s],i)}function cn(t,e,i,l,s,c){let o,h,u;if(e==="style")return zt(t,i,l);if(e==="classList")return Mt(t,i,l);if(i===l)return l;if(e==="ref")c||i(t);else if(e.slice(0,3)==="on:"){const d=e.slice(3);l&&t.removeEventListener(d,l),i&&t.addEventListener(d,i)}else if(e.slice(0,10)==="oncapture:"){const d=e.slice(10);l&&t.removeEventListener(d,l,!0),i&&t.addEventListener(d,i,!0)}else if(e.slice(0,2)==="on"){const d=e.slice(2).toLowerCase(),m=It.has(d);if(!m&&l){const f=Array.isArray(l)?l[0]:l;t.removeEventListener(d,f)}(m||i)&&(St(t,d,i,m),m&&F([d]))}else if((u=Ot.has(e))||!s&&(sn[e]||(h=xt.has(e)))||(o=t.nodeName.includes("-")))e==="class"||e==="className"?I(t,i):o&&!h&&!u?t[Ut(e)]=i:t[sn[e]||e]=i;else{const d=s&&e.indexOf(":")>-1&&Rt[e.split(":")[0]];d?Vt(t,d,e,i):V(t,Pt[e]||e,i)}return i}function Ft(t){const e=`$$${t.type}`;let i=t.composedPath&&t.composedPath()[0]||t.target;for(t.target!==i&&Object.defineProperty(t,"target",{configurable:!0,value:i}),Object.defineProperty(t,"currentTarget",{configurable:!0,get(){return i||document}}),j.registry&&!j.done&&(j.done=!0,document.querySelectorAll("[id^=pl-]").forEach(l=>{for(;l&&l.nodeType!==8&&l.nodeValue!=="pl-"+t;){let s=l.nextSibling;l.remove(),l=s}l&&l.remove()}));i;){const l=i[e];if(l&&!i.disabled){const s=i[`${e}Data`];if(s!==void 0?l.call(i,s,t):l.call(i,t),t.cancelBubble)return}i=i._$host||i.parentNode||i.host}}function K(t,e,i,l,s){for(j.context&&!i&&(i=[...t.childNodes]);typeof i=="function";)i=i();if(e===i)return i;const c=typeof e,o=l!==void 0;if(t=o&&i[0]&&i[0].parentNode||t,c==="string"||c==="number"){if(j.context)return i;if(c==="number"&&(e=e.toString()),o){let h=i[0];h&&h.nodeType===3?h.data=e:h=document.createTextNode(e),i=H(t,i,l,h)}else i!==""&&typeof i=="string"?i=t.firstChild.data=e:i=t.textContent=e}else if(e==null||c==="boolean"){if(j.context)return i;i=H(t,i,l)}else{if(c==="function")return E(()=>{let h=e();for(;typeof h=="function";)h=h();i=K(t,h,i,l)}),()=>i;if(Array.isArray(e)){const h=[],u=i&&Array.isArray(i);if(Se(h,e,i,s))return E(()=>i=K(t,h,i,l,!0)),()=>i;if(j.context){if(!h.length)return i;for(let d=0;d<h.length;d++)if(h[d].parentNode)return i=h}if(h.length===0){if(i=H(t,i,l),o)return i}else u?i.length===0?on(t,h,l):$t(t,i,h):(i&&H(t),on(t,h));i=h}else if(e instanceof Node){if(j.context&&e.parentNode)return i=o?[e]:e;if(Array.isArray(i)){if(o)return i=H(t,i,l,e);H(t,i,null,e)}else i==null||i===""||!t.firstChild?t.appendChild(e):t.replaceChild(e,t.firstChild);i=e}else console.warn("Unrecognized value. Skipped inserting",e)}return i}function Se(t,e,i,l){let s=!1;for(let c=0,o=e.length;c<o;c++){let h=e[c],u=i&&i[c];if(h instanceof Node)t.push(h);else if(!(h==null||h===!0||h===!1))if(Array.isArray(h))s=Se(t,h,u)||s;else if(typeof h=="function")if(l){for(;typeof h=="function";)h=h();s=Se(t,Array.isArray(h)?h:[h],Array.isArray(u)?u:[u])||s}else t.push(h),s=!0;else{const d=String(h);d==="<!>"?u&&u.nodeType===8&&t.push(u):u&&u.nodeType===3?(u.data=d,t.push(u)):t.push(document.createTextNode(d))}}return s}function on(t,e,i=null){for(let l=0,s=e.length;l<s;l++)t.insertBefore(e[l],i)}function H(t,e,i,l){if(i===void 0)return t.textContent="";const s=l||document.createTextNode("");if(e.length){let c=!1;for(let o=e.length-1;o>=0;o--){const h=e[o];if(s!==h){const u=h.parentNode===t;!c&&!o?u?t.replaceChild(s,h):t.insertBefore(s,i):u&&h.remove()}else c=!0}}else t.insertBefore(s,i);return[s]}function Xt(){const t=j.context;return`${t.id}${t.count++}`}const Ht=!1,Wt="http://www.w3.org/2000/svg";function Gt(t,e=!1){return e?document.createElementNS(Wt,t):document.createElement(t)}function Yt(t){const[e,i]=Un(t,["component"]),l=b(()=>e.component);return b(()=>{const s=l();switch(typeof s){case"function":return Object.assign(s,{[ft]:!0}),$(()=>s(i));case"string":const c=Dt.has(s),o=j.context?Bt():Gt(s,c);return Fn(o,i,c),o}})}function Kt(t,e,i){return t.addEventListener(e,i),()=>t.removeEventListener(e,i)}function Zt([t,e],i,l){return[i?()=>i(t()):t,l?s=>e(l(s)):e]}function Jt(t){try{return document.querySelector(t)}catch{return null}}function Qt(t,e){const i=Jt(`#${t}`);i?i.scrollIntoView():e&&window.scrollTo(0,0)}function ei(t,e,i,l){let s=!1;const c=h=>typeof h=="string"?{value:h}:h,o=Zt(L(c(t()),{equals:(h,u)=>h.value===u.value}),void 0,h=>(!s&&e(h),h));return i&&Te(i((h=t())=>{s=!0,o[1](c(h)),s=!1})),{signal:o,utils:l}}function ni(t){if(t){if(Array.isArray(t))return{signal:t}}else return{signal:L({value:""})};return t}function ti(){return ei(()=>({value:window.location.pathname+window.location.search+window.location.hash,state:history.state}),({value:t,replace:e,scroll:i,state:l})=>{e?window.history.replaceState(l,"",t):window.history.pushState(l,"",t),Qt(window.location.hash.slice(1),i)},t=>Kt(window,"popstate",()=>t()),{go:t=>window.history.go(t)})}function ii(){let t=new Set;function e(s){return t.add(s),()=>t.delete(s)}let i=!1;function l(s,c){if(i)return!(i=!1);const o={to:s,options:c,defaultPrevented:!1,preventDefault:()=>o.defaultPrevented=!0};for(const h of t)h.listener({...o,from:h.location,retry:u=>{u&&(i=!0),h.navigate(s,c)}});return!o.defaultPrevented}return{subscribe:e,confirm:l}}const li=/^(?:[a-z0-9]+:)?\/\//i,si=/^\/+|\/+$/g;function U(t,e=!1){const i=t.replace(si,"");return i?e||/^[?#]/.test(i)?i:"/"+i:""}function ge(t,e,i){if(li.test(e))return;const l=U(t),s=i&&U(i);let c="";return!s||e.startsWith("/")?c=l:s.toLowerCase().indexOf(l.toLowerCase())!==0?c=l+s:c=s,(c||"/")+U(e,!c)}function ri(t,e){if(t==null)throw new Error(e);return t}function Xn(t,e){return U(t).replace(/\/*(\*.*)?$/g,"")+U(e)}function ai(t){const e={};return t.searchParams.forEach((i,l)=>{e[l]=i}),e}function ci(t,e){const[i,l]=t.split("/*",2),s=i.split("/").filter(Boolean),c=s.length;return o=>{const h=o.split("/").filter(Boolean),u=h.length-c;if(u<0||u>0&&l===void 0&&!e)return null;const d={path:c?"":"/",params:{}};for(let m=0;m<c;m++){const f=s[m],A=h[m];if(f[0]===":")d.params[f.slice(1)]=A;else if(f.localeCompare(A,void 0,{sensitivity:"base"})!==0)return null;d.path+=`/${A}`}return l&&(d.params[l]=u?h.slice(-u).join("/"):""),d}}function oi(t){const[e,i]=t.pattern.split("/*",2),l=e.split("/").filter(Boolean);return l.reduce((s,c)=>s+(c.startsWith(":")?2:3),l.length-(i===void 0?0:1))}function Hn(t){const e=new Map,i=vt();return new Proxy({},{get(l,s){return e.has(s)||wt(i,()=>e.set(s,b(()=>t()[s]))),e.get(s)()},getOwnPropertyDescriptor(){return{enumerable:!0,configurable:!0}},ownKeys(){return Reflect.ownKeys(t())}})}function Wn(t){let e=/(\/?\:[^\/]+)\?/.exec(t);if(!e)return[t];let i=t.slice(0,e.index),l=t.slice(e.index+e[0].length);const s=[i,i+=e[1]];for(;e=/^(\/\:[^\/]+)\?/.exec(l);)s.push(i+=e[1]),l=l.slice(e[0].length);return Wn(l).reduce((c,o)=>[...c,...s.map(h=>h+o)],[])}const hi=100,Gn=Vn(),Oe=Vn(),Pe=()=>ri(Fe(Gn),"Make sure your app is wrapped in a <Router />");let ae;const Ye=()=>ae||Fe(Oe)||Pe().base,di=t=>{const e=Ye();return b(()=>e.resolvePath(t()))},ui=t=>{const e=Pe();return b(()=>{const i=t();return i!==void 0?e.renderPath(i):i})},Z=()=>Pe().location;function mi(t,e="",i){const{component:l,data:s,children:c}=t,o=!c||Array.isArray(c)&&!c.length,h={key:t,element:l?()=>p(l,{}):()=>{const{element:u}=t;return u===void 0&&i?p(i,{}):u},preload:t.component?l.preload:t.preload,data:s};return Yn(t.path).reduce((u,d)=>{for(const m of Wn(d)){const f=Xn(e,m),A=o?f:f.split("/*",1)[0];u.push({...h,originalPath:m,pattern:A,matcher:ci(A,!o)})}return u},[])}function pi(t,e=0){return{routes:t,score:oi(t[t.length-1])*1e4-e,matcher(i){const l=[];for(let s=t.length-1;s>=0;s--){const c=t[s],o=c.matcher(i);if(!o)return null;l.unshift({...o,route:c})}return l}}}function Yn(t){return Array.isArray(t)?t:[t]}function Kn(t,e="",i,l=[],s=[]){const c=Yn(t);for(let o=0,h=c.length;o<h;o++){const u=c[o];if(u&&typeof u=="object"&&u.hasOwnProperty("path")){const d=mi(u,e,i);for(const m of d){l.push(m);const f=Array.isArray(u.children)&&u.children.length===0;if(u.children&&!f)Kn(u.children,m.pattern,i,l,s);else{const A=pi([...l],s.length);s.push(A)}l.pop()}}}return l.length?s:s.sort((o,h)=>h.score-o.score)}function _i(t,e){for(let i=0,l=t.length;i<l;i++){const s=t[i].matcher(e);if(s)return s}return[]}function gi(t,e){const i=new URL("http://sar"),l=b(u=>{const d=t();try{return new URL(d,i)}catch{return console.error(`Invalid path ${d}`),u}},i,{equals:(u,d)=>u.href===d.href}),s=b(()=>l().pathname),c=b(()=>l().search,!0),o=b(()=>l().hash),h=b(()=>"");return{get pathname(){return s()},get search(){return c()},get hash(){return o()},get state(){return e()},get key(){return h()},query:Hn(Ue(c,()=>ai(l())))}}function fi(t,e="",i,l){const{signal:[s,c],utils:o={}}=ni(t),h=o.parsePath||(N=>N),u=o.renderPath||(N=>N),d=o.beforeLeave||ii(),m=ge("",e),f=void 0;if(m===void 0)throw new Error(`${m} is not a valid base path`);m&&!s().value&&c({value:m,replace:!0,scroll:!1});const[A,x]=L(!1),k=async N=>{x(!0);try{await yt(N)}finally{x(!1)}},[J,Q]=L(s().value),[ee,ue]=L(s().state),en=gi(J,ee),ne=[],X={pattern:m,params:{},path:()=>m,outlet:()=>null,resolvePath(N){return ge(m,N)}};if(i)try{ae=X,X.data=i({data:void 0,params:{},location:en,navigate:tn(X)})}finally{ae=void 0}function nn(N,w,O){$(()=>{if(typeof w=="number"){w&&(o.go?d.confirm(w,O)&&o.go(w):console.warn("Router integration does not support relative routing"));return}const{replace:me,resolve:pe,scroll:S,state:te}={replace:!1,resolve:!0,scroll:!0,...O},M=pe?N.resolvePath(w):ge("",w);if(M===void 0)throw new Error(`Path '${w}' is not a routable path`);if(ne.length>=hi)throw new Error("Too many redirects");const ie=J();if((M!==ie||te!==ee())&&!Ht){if(d.confirm(M,O)){const pt=ne.push({value:ie,replace:me,scroll:S,state:ee()});k(()=>{Q(M),ue(te)}).then(()=>{ne.length===pt&&mt({value:M,state:te})})}}})}function tn(N){return N=N||Fe(Oe)||X,(w,O)=>nn(N,w,O)}function mt(N){const w=ne[0];w&&((N.value!==w.value||N.state!==w.state)&&c({...N,replace:w.replace,scroll:w.scroll}),ne.length=0)}E(()=>{const{value:N,state:w}=s();$(()=>{N!==J()&&k(()=>{Q(N),ue(w)})})});{let N=function(w){if(w.defaultPrevented||w.button!==0||w.metaKey||w.altKey||w.ctrlKey||w.shiftKey)return;const O=w.composedPath().find(ie=>ie instanceof Node&&ie.nodeName.toUpperCase()==="A");if(!O||!O.hasAttribute("link"))return;const me=O.href;if(O.target||!me&&!O.hasAttribute("state"))return;const pe=(O.getAttribute("rel")||"").split(/\s+/);if(O.hasAttribute("download")||pe&&pe.includes("external"))return;const S=new URL(me);if(S.origin!==window.location.origin||m&&S.pathname&&!S.pathname.toLowerCase().startsWith(m.toLowerCase()))return;const te=h(S.pathname+S.search+S.hash),M=O.getAttribute("state");w.preventDefault(),nn(X,te,{resolve:!1,replace:O.hasAttribute("replace"),scroll:!O.hasAttribute("noscroll"),state:M&&JSON.parse(M)})};var Us=N;F(["click"]),document.addEventListener("click",N),Te(()=>document.removeEventListener("click",N))}return{base:X,out:f,location:en,isRouting:A,renderPath:u,parsePath:h,navigatorFactory:tn,beforeLeave:d}}function bi(t,e,i,l){const{base:s,location:c,navigatorFactory:o}=t,{pattern:h,element:u,preload:d,data:m}=l().route,f=b(()=>l().path),A=Hn(()=>l().params);d&&d();const x={parent:e,pattern:h,get child(){return i()},path:f,params:A,data:e.data,outlet:u,resolvePath(k){return ge(s.path(),k,f())}};if(m)try{ae=x,x.data=m({data:e.data,params:A,location:c,navigate:o(x)})}finally{ae=void 0}return x}const vi=g("<a link></a>",2),wi=t=>{const{source:e,url:i,base:l,data:s,out:c}=t,o=e||ti(),h=fi(o,l,s);return p(Gn.Provider,{value:h,get children(){return t.children}})},yi=t=>{const e=Pe(),i=Ye(),l=Xe(()=>t.children),s=b(()=>Kn(l(),Xn(i.pattern,t.base||""),Zn)),c=b(()=>_i(s(),e.location.pathname));e.out&&e.out.matches.push(c().map(({route:d,path:m,params:f})=>({originalPath:d.originalPath,pattern:d.pattern,path:m,params:f})));const o=[];let h;const u=b(Ue(c,(d,m,f)=>{let A=m&&d.length===m.length;const x=[];for(let k=0,J=d.length;k<J;k++){const Q=m&&m[k],ee=d[k];f&&Q&&ee.route.key===Q.route.key?x[k]=f[k]:(A=!1,o[k]&&o[k](),Rn(ue=>{o[k]=ue,x[k]=bi(e,x[k-1]||i,()=>u()[k+1],()=>c()[k])}))}return o.splice(d.length).forEach(k=>k()),f&&A?f:(h=x[0],x)}));return p(Ge,{get when(){return u()&&h},children:d=>p(Oe.Provider,{value:d,get children(){return d.outlet()}})})},G=t=>{const e=Xe(()=>t.children);return Ne(t,{get children(){return e()}})},Zn=()=>{const t=Ye();return p(Ge,{get when(){return t.child},children:e=>p(Oe.Provider,{value:e,get children(){return e.outlet()}})})};function D(t){t=Ne({inactiveClass:"inactive",activeClass:"active"},t);const[,e]=Un(t,["href","state","class","activeClass","inactiveClass","end"]),i=di(()=>t.href),l=ui(i),s=Z(),c=b(()=>{const o=i();if(o===void 0)return!1;const h=U(o.split(/[?#]/,1)[0]).toLowerCase(),u=U(s.pathname).toLowerCase();return t.end?h===u:u.startsWith(h)});return(()=>{const o=vi.cloneNode(!0);return Fn(o,Ne(e,{get href(){return l()||t.href},get state(){return JSON.stringify(t.state)},get classList(){return{...t.class&&{[t.class]:!0},[t.inactiveClass]:!c(),[t.activeClass]:c(),...e.classList}},get["aria-current"](){return c()?"page":void 0}}),!1,!1),o})()}var Ni=t=>t[0]!==t[0].toLowerCase(),ji=/e(r[HRWrv]|[Vawy])|Con|l(e[Tcs]|c)|s(eP|y)|a(t[rt]|u|v)|Of|Ex|f[XYa]|gt|hR|d[Pg]|t[TXYd]|[UZq]/,hn=Object.create(null),Ei=/[A-Z]/g,ki=t=>hn[t]||(hn[t]=ji.test(t)?t:t.replace(Ei,e=>`-${e.toLowerCase()}`)),Ai=/^(t(ext$|s)|s[vwy]|g)|^set|tad|ker|p(at|s)|s(to|c$|ca|k)|r(ec|cl)|ew|us|f($|e|s)|cu|n[ei]|l[ty]|[GOP]/,De={},Li=t=>t in De?De[t]:De[t]=Ai.test(t)&&!t.includes("-"),Ti=new Set(["mjx"]),xi=new RegExp(`(?:${[...Ti].join("|")})-.+`,"g"),dn=Object.create(null),Jn=t=>typeof t=="string"?dn[t]??(dn[t]=t.replace(xi,e=>e.replace(/-/g,"_"))):t,Me=(t,e)=>{let i={};for(let l of Object.keys(t))i[Oi(l,e)]=typeof t[l]=="object"&&!Array.isArray(t[l])?Me(t[l],e):Jn(t[l]);return i},T=t=>t.children,n=(t,e)=>typeof t=="function"?t.name==="Fragment"?T(e):t(Me(e)):p(Yt,Ne(Ni(t)?e:Me(e,t),{component:Jn(t)})),Oi=(t,e="")=>Li(e)?t=t==="xlinkHref"||t==="xlink:href"?"href":ki(t):t,a=n;const Pi=g('<button><div text-base=""></div></button>',4),Ii=g('<div grid="" gap-5=""><div class="[&amp;_*]:rounded-lg [&amp;_button]:p-3 [&amp;_button]:w-fit vertCentered !gap-3"></div><pre class="hljs"></pre></div>',6),[Di,Qn]=L("Linux / Macos"),et="git clone https://github.com/NvChad/NvChad ~/.config/nvim --depth 1 && nvim",Ri="git clone https://github.com/NvChad/NvChad $HOME\\AppData\\Local\\nvim --depth 1 && nvim",$i=`docker run -w /root -it --rm alpine:latest sh -uelic '
  apk add git nodejs neovim ripgrep build-base --update
  git clone https://github.com/NvChad/NvChad ~/.config/nvim
  nvim
  '`,[Ci,Vi]=L(et),Re=t=>{const{cmd:e,os:i,icon:l}=t;return(()=>{const s=Pi.cloneNode(!0),c=s.firstChild;return s.$$click=()=>{Qn(i),Vi(e)},I(c,l),_(s,i,null),E(()=>I(s,`!text-vsm ${Di()==i?"text-white-1 bg-blue-6 dark:bg-blue-3 dark:text-dark-1":"bg-slate-1"}`)),s})()},Si=()=>(()=>{const t=Ii.cloneNode(!0),e=t.firstChild,i=e.nextSibling;return _(e,p(Re,{os:"Linux / Macos",cmd:et,icon:"i-mingcute:hashtag-fill"}),null),_(e,p(Re,{os:"Windows",cmd:Ri,icon:"i-mdi:windows"}),null),_(e,p(Re,{os:"Docker",cmd:$i,icon:"i-nonicons:docker-16"}),null),_(i,Ci),t})();F(["click"]);function un(t){const e=Object.assign({h2:"h2",ul:"ul",li:"li",a:"a",code:"code",p:"p",pre:"pre",span:"span"},t.components);return a(T,{children:[n(e.h2,{children:"Pre-requisites"}),`
`,a(e.ul,{children:[`
