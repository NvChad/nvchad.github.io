import{b as n,m as a,i,t}from"./web-DScAkgcG.js";import{M as l}from"./index-CYDpJFld.js";var c=t("<kbd>Alt+1");function r(s){const e={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l(),...s.components};return[n(e.h1,{children:"NvChad API"}),`
...
`]}})}})]}function u(s={}){const{wrapper:e}={...l(),...s.components};return e?n(e,a(s,{get children(){return n(r,s)}})):r(s)}export{u as default};
