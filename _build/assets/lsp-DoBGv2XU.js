import{b as e,q as o,k as l,t as c,m as h}from"./web-CBU83r8B.js";import{M as t}from"./index-C2YDUEaq.js";var i=c("<br>"),d=c("<u>");const g={title:"NvChad Lsp Configuration",desc:"Manage lsp servers & mason.nvim in NvChad"};function r(s){const n={a:"a",blockquote:"blockquote",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...t(),...s.components};return[e(n.h2,{children:"Setup lsp server"}),`
...
`]}})]}function u(s={}){const{wrapper:n}={...t(),...s.components};return n?e(n,o(s,{get children(){return e(r,s)}})):r(s)}export{u as default,g as meta};
