import{M as a}from"./index-BosUlz4E.js";import{b as e,q as i}from"./web-uzQsy4d_.js";const r={title:"NvChad Plugins",desc:"Maintain plugins in NvChad"};function l(s){const n={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...s.components};return[e(n.h2,{children:"Overview"}),`
...
`,e(n.pre,{get children(){return e(n.code,{className:"hljs language-lua",get children(){return[e(n.span,{className:"hljs-keyword",children:"local"}),` plugins = {
  ...
  { `,e(n.span,{className:"hljs-string",children:'"folke/which-key.nvim"'}),",  enabled = ",e(n.span,{className:"hljs-literal",children:"false"}),` },
  ...
  `,e(n.span,{className:"hljs-comment",children:"-- You can use any plugin specification from lazy.nvim"}),`
  {
    ...
    `,e(n.span,{className:"hljs-built_in",children:"config"})," = ",e(n.span,{className:"hljs-function",get children(){return[e(n.span,{className:"hljs-keyword",children:"function"}),e(n.span,{className:"hljs-params",children:"()"})]}}),`
      `,e(n.span,{className:"hljs-built_in",children:"require"})," ",e(n.span,{className:"hljs-string",children:'"configs.truezen"'})," ",e(n.span,{className:"hljs-comment",children:"-- just an example path"}),`
