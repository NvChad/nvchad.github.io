...
`]}}),`
`]}}),c,I),l(i,n(e.h2,{children:"Lazy.nvim"}),o,q),l(i,n(e.ul,{get children(){return[`
...
`]}}),h,H),l(i,n(e.pre,{get children(){return n(e.code,{className:"hljs language-lua",get children(){return[n(e.span,{className:"hljs-comment",children:"--  before "}),`
...
`]}}),Ne,ye),i})()}function Re(r={}){const{wrapper:e}={...R(),...r.components};return e?n(e,we(r,{get children(){return n(T,r)}})):T(r)}export{Re as default,Me as meta};
