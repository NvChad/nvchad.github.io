import{e as x,h as w,i as d,k as o,j as i,b as g,a as L,t as h,q as u,n as D,r as M}from"./web-DScAkgcG.js";var P=h("<button><div text-base></div><!$><!/>"),O=h("<div grid gap-5><div flex flex-wrap class=[&amp;_button]:p-3 gap-3><!$><!/><!$><!/><!$><!/></div><!$><!/>"),b=h("<pre class=hljs>");const[R,y]=x("Linux / Macos"),C="git clone https://github.com/NvChad/NvChad ~/.config/nvim --depth 1 && nvim",U=[`# if you're using Command Prompt(CMD) 
