import{b as n,m as l,i as a,t as i}from"./web-DScAkgcG.js";import{M as r}from"./index-CYDpJFld.js";var c=i("<br>");function t(s){const e={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...r(),...s.components};return[n(e.h1,{children:"Nvim-treesitter"}),`
...
`]}})}})]}function d(s={}){const{wrapper:e}={...r(),...s.components};return e?n(e,l(s,{get children(){return n(t,s)}})):t(s)}export{d as default};
