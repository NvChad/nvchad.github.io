...
`,n(e.li,{get children(){return[n(e.a,{href:"https://github.com/folke/which-key.nvim",get children(){return n(e.code,{children:"which-key.nvim"})}})," - Create key bindings that stick. WhichKey helps you remember your Neovim keymaps, by showing available keybindings in a popup as you type."]}}),`
`,n(e.li,{get children(){return[n(e.a,{href:"https://github.com/NvChad/nvim-colorizer.lua",get children(){return n(e.code,{children:"nvim-colorizer.lua"})}})," - The fastest Neovim colorizer."]}}),`
...
`,n(e.li,{get children(){return[n(e.a,{href:"https://github.com/lukas-reineke/indent-blankline.nvim",get children(){return n(e.code,{children:"indent-blankline.nvim"})}})," - Indent guides for Neovim."]}}),`
...
`,n(e.li,{get children(){return[n(e.a,{href:"https://github.com/windwp/nvim-autopairs",get children(){return n(e.code,{children:"nvim-autopairs"})}})," - Autopairs for neovim written in lua."]}}),`
...
`]}})]}function w(i={}){const{wrapper:e}={...c(),...i.components};return e?n(e,s(i,{get children(){return n(a,i)}})):a(i)}export{w as default,v as meta};
