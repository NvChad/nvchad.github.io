import{b as e,q as o,k as t,t as l}from"./web-uzQsy4d_.js";import{M as a}from"./index-BosUlz4E.js";import{O as s}from"./install-CQ1n8RFs.js";import"./clipboard-DzJ4oxno.js";var c=l("<strong>Mono"),d=l("<strong>Example : "),h=l("<s>JetbrainsMono Nerd Font Mono"),m=l("<strong>(OPTIONAL)"),u=l("<br>");const w={title:"NvChad Installation",desc:"Install, Update, Uninstall guide for nvchad"};function i(r){const n={a:"a",code:"code",h2:"h2",li:"li",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...r.components};return[e(n.h2,{children:"Pre-requisites"}),`
...
`,e(n.span,{className:"hljs-built_in",children:"rm"}),` -Force ~\\AppData\\Local\\nvim-data
`]}})}})]}function N(r={}){const{wrapper:n}={...a(),...r.components};return n?e(n,o(r,{get children(){return e(i,r)}})):i(r)}export{N as default,w as meta};
