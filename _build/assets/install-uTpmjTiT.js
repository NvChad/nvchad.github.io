import{b as e,m as s,i as t,t as l}from"./web-BodIy5GG.js";import{M as a}from"./index-Cy02P5WC.js";import{O as o}from"./install-C_DKe7hi.js";import"./clipboard-DzJ4oxno.js";var c=l("<strong>Mono"),h=l("<strong>Example : "),d=l("<s>JetbrainsMono Nerd Font Mono"),m=l("<strong>(OPTIONAL)");function i(r){const n={a:"a",code:"code",h2:"h2",li:"li",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...r.components};return[e(n.h2,{children:"Pre-requisites"}),`
...
`,e(n.span,{className:"hljs-built_in",children:"rm"}),` -Force ~\\AppData\\Local\\nvim-data
`]}})}})]}function w(r={}){const{wrapper:n}={...a(),...r.components};return n?e(n,s(r,{get children(){return e(i,r)}})):i(r)}export{w as default};
