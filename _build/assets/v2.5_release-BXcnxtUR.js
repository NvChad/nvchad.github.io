...
`,n(e.li,{get children(){return[r(d)," is the command"]}}),`
`]}}),`
...
`]}})]}function g(t={}){const{wrapper:e}={...l(),...t.components};return e?n(e,o(t,{get children(){return n(h,t)}})):h(t)}const y=Object.freeze(Object.defineProperty({__proto__:null,default:g,meta:m},Symbol.toStringTag,{value:"Module"}));var p=i("<br>");const f={title:"NvChad v2.5 released!",desc:"Minor NvChad release with standard neovim config structure, new 7 themes, UI Term module replacing nvterm.",cover:"v2.5.webp"};function c(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",ul:"ul",...l(),...t.components};return[n(e.h1,{children:"NvChad v2.5 Released!"}),`
