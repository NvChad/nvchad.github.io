import{b as n,q as r,k as c,t as h}from"./web-DqPol8Cv.js";import{M as a}from"./index-yHsRVhWw.js";var i=h("<br>");const t={title:"Learn basic lua",desc:"Learn basic lua in 15 minutes from nvchad docs"};function l(e){const s={code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...e.components};return[n(s.h2,{children:"Comments"}),`
...
`,n(s.pre,{get children(){return n(s.code,{className:"hljs language-lua",get children(){return[n(s.span,{className:"hljs-keyword",children:"local"})," x = ",n(s.span,{className:"hljs-number",children:"10"})," ",n(s.span,{className:"hljs-comment",children:"-- number"}),`
...
`,n(s.pre,{get children(){return n(s.code,{className:"hljs language-lua",get children(){return[` == equal
 < less than
 > greater than
 ...
 ~= `,n(s.span,{className:"hljs-keyword",children:"not"}),` equal
`]}})}}),`
...
`]}})}}),`
`,n(s.h2,{children:"vim.tbl_deep_extend"}),`
`,n(s.p,{children:"This is a neovim function which is used for merging tables and their values recursively. Most plugins use it for merging config tables."}),`
`,n(s.pre,{get children(){return n(s.code,{className:"hljs language-lua",get children(){return[n(s.span,{className:"hljs-comment",children:"-- table 1"}),`
`,n(s.span,{className:"hljs-keyword",children:"local"}),` person = {
    name = `,n(s.span,{className:"hljs-string",children:'"joe"'}),`,
    age = `,n(s.span,{className:"hljs-number",children:"19"}),`,
    skills = {`,n(s.span,{className:"hljs-string",children:'"python"'}),", ",n(s.span,{className:"hljs-string",children:'"html"'}),`},
}

`,n(s.span,{className:"hljs-comment",children:"-- table 2"}),`
`,n(s.span,{className:"hljs-keyword",children:"local"}),` someone = {
    name = `,n(s.span,{className:"hljs-string",children:'"siduck"'}),`,
    skills = {`,n(s.span,{className:"hljs-string",children:'"js"'}),", ",n(s.span,{className:"hljs-string",children:'"lua"'}),`},
}

`,n(s.span,{className:"hljs-comment",children:'-- "force" will overwrite equal values from the someone table over the person table'}),`
`,n(s.span,{className:"hljs-keyword",children:"local"})," result = vim.tbl_deep_extend(",n(s.span,{className:"hljs-string",children:'"force"'}),`, person, someone)

`,n(s.span,{className:"hljs-comment",children:"-- result : "}),`
{
    name = `,n(s.span,{className:"hljs-string",children:'"siduck"'}),`,
    age = `,n(s.span,{className:"hljs-number",children:"19"}),`,
    skills = {`,n(s.span,{className:"hljs-string",children:'"js"'}),", ",n(s.span,{className:"hljs-string",children:'"lua"'}),`},
...
`,n(s.span,{className:"hljs-comment",children:"-- The list tables wont merge cuz they dont have keys "}),`
`]}})}}),`
`,c(i),`
`,n(s.ul,{get children(){return[`
`,n(s.li,{children:"check :h vim.tbl_deep_extend for more info"}),`
`]}})]}function o(e={}){const{wrapper:s}={...a(),...e.components};return s?n(s,r(e,{get children(){return n(l,e)}})):l(e)}export{o as default,t as meta};
