import{b as n,q as a,k as r,t as i}from"./web-DqPol8Cv.js";import{M as l}from"./index-yHsRVhWw.js";var c=i("<br>");const g={title:"UI plugin v3.0",desc:"NvChad's Base46 and UI plugin can now be used by non nvchad users! docs at :h nvui",cover:"nvui.webp",order:3};function h(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",img:"img",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l(),...t.components};return[n(e.h1,{children:"NvUI v3.0 ( NvChad's UI + Base46 )"}),`
...
`]}}),`
`]}})]}function m(t={}){const{wrapper:e}={...l(),...t.components};return e?n(e,a(t,{get children(){return n(h,t)}})):h(t)}const S=Object.freeze(Object.defineProperty({__proto__:null,default:m,meta:g},Symbol.toStringTag,{value:"Module"}));var s=i("<br>"),p=i('<iframe src=https://www.youtube.com/embed/xytzreFq_us title="YouTube video player"frameborder=0 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"allow=fullscreen>'),f=i("<u>NvDash"),v=i('<iframe src=https://www.youtube.com/embed/IljDD4cjgKc title="YouTube video player"frameborder=0 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"allow=fullscreen;>');const b={title:"NvChad v2.0 released!",desc:"New UI features & using lazy.nvim. Improvements in startuptime, using base46 theme compiler",cover:"v2.0.webp",order:1};function o(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",img:"img",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l(),...t.components};return[n(e.h1,{children:"Announcing NvChad v2.0"}),`
...
`,n(e.li,{get children(){return[r(f)," is the command"]}}),`
`]}}),`
...
`]}})]}function w(t={}){const{wrapper:e}={...l(),...t.components};return e?n(e,a(t,{get children(){return n(o,t)}})):o(t)}const T=Object.freeze(Object.defineProperty({__proto__:null,default:w,meta:b},Symbol.toStringTag,{value:"Module"}));var y=i("<br>");const N={title:"NvChad v2.5 released!",desc:"Minor NvChad release with standard neovim config structure, new themes & term module.",cover:"v2.5.webp",order:2};function d(t){const e={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...t.components};return[n(e.h1,{children:"NvChad v2.5 Released!"}),`
...
`,n(e.p,{get children(){return n(e.img,{src:"/themes/solarized_oska.webp",alt:"solarized_oska theme"})}})]}function _(t={}){const{wrapper:e}={...l(),...t.components};return e?n(e,a(t,{get children(){return n(d,t)}})):d(t)}const z=Object.freeze(Object.defineProperty({__proto__:null,default:_,meta:N},Symbol.toStringTag,{value:"Module"}));var k=i('<iframe width=560 height=315 src="https://www.youtube.com/embed/NHC4jLoR_zI?si=E9upX0ZWT-c5q7v6"title="YouTube video player"frameborder=0 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"referrerpolicy=strict-origin-when-cross-origin allowfullscreen>'),C=i('<iframe width=560 height=315 src="https://www.youtube.com/embed/VauET3tR2J4?si=cT1BTkgXweBTNZWW"title="YouTube video player"frameborder=0 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"referrerpolicy=strict-origin-when-cross-origin allowfullscreen>');const M={title:"Volt framework",desc:"Build Interactive UI for Neovim using the Volt framework! 100% Mouse friendly",cover:"volt.webp",order:4};function u(t){const e={a:"a",h1:"h1",h2:"h2",img:"img",p:"p",...l(),...t.components};return[n(e.h1,{children:"Volt UI Framework"}),`
...
`,r(C)]}function j(t={}){const{wrapper:e}={...l(),...t.components};return e?n(e,a(t,{get children(){return n(u,t)}})):u(t)}const $=Object.freeze(Object.defineProperty({__proto__:null,default:j,meta:M},Symbol.toStringTag,{value:"Module"}));export{S as _,T as a,z as b,$ as c};
