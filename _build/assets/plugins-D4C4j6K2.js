import{M as a}from"./index-Cy02P5WC.js";import{b as e,m as i}from"./web-BodIy5GG.js";function l(s){const n={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...s.components};return[e(n.h2,{children:"Overview"}),`
...
`,e(n.pre,{get children(){return e(n.code,{className:"hljs language-lua",get children(){return[e(n.span,{className:"hljs-keyword",children:"local"}),` plugins = {
  ...
  `,e(n.span,{className:"hljs-comment",children:"-- If your opts uses a function call, then make opts spec a function*"}),`
  ...
  `,e(n.span,{className:"hljs-comment",children:"-- and then assign a function to some of its options"}),`
  {
...
`]}})}})]}function r(s={}){const{wrapper:n}={...a(),...s.components};return n?e(n,i(s,{get children(){return e(l,s)}})):l(s)}export{r as default};
