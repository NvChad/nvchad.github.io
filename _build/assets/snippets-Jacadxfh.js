import{b as n,q as i,k as r,t as l}from"./web-DqPol8Cv.js";import{M as a}from"./index-yHsRVhWw.js";var o=l("<br>");const h={title:"NvChad Snippets",desc:"Manage custom snippets in NvChad"};function s(t){const e={a:"a",blockquote:"blockquote",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...a(),...t.components};return[n(e.h2,{children:"Luasnip"}),`
...
`,n(e.pre,{get children(){return n(e.code,{className:"hljs language-lua",get children(){return[n(e.span,{className:"hljs-comment",children:"-- using with vscode extensions. i.e ~/.vscode/extensions/deinsoftware.vitest-snippets-1.8.0"}),`
vim.g.vscode_snippets_path = `,n(e.span,{className:"hljs-string",children:'"path to your vscode snippet extension directory"'}),`
...
`]}})]}function d(t={}){const{wrapper:e}={...a(),...t.components};return e?n(e,i(t,{get children(){return n(s,t)}})):s(t)}export{d as default,h as meta};
