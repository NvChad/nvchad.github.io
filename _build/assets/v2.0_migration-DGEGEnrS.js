import{b as n,m as h,i,t as a,j as o}from"./web-BodIy5GG.js";import{M as c}from"./index-Cy02P5WC.js";var d=a("<u>"),t=a("<br>");const m={heading:"Breaking changes in v2.0",details:"NvChad's v2.0 uses lazy.nvim instead of packer so there are slight differences in the plugin related syntax & some commands have been removed.",cover:"v2.0_migration.svg"};function s(r){const e={a:"a",code:"code",h1:"h1",h2:"h2",img:"img",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...c(),...r.components};return[n(e.h1,{children:"Breaking changes in v2.0"}),`
...
`,n(e.li,{get children(){return["The string should be path of your file which returns a table, example : ",(()=>{var l=i(d);return o(l,n(e.strong,{children:"custom/plugins.lua"})),l})()]}}),`
`]}}),`
