import{b as e,m as t,i as s,t as a}from"./web-DScAkgcG.js";import{M as i}from"./index-CYDpJFld.js";var h=a("<kbd>Ctrl"),d=a("<kbd>Space"),o=a("<kbd>alt"),p=a("<kbd>shift"),r=a("<br>");function c(l){const n={blockquote:"blockquote",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...i(),...l.components};return[e(n.h2,{children:"Overview"}),`
...
`,s(r),`
`,e(n.ul,{get children(){return[`
`,e(n.li,{get children(){return["The default mappings are defined in ",e(n.code,{children:"core.mappings"})," (",e(n.code,{children:"core/mappings.lua"}),")."]}}),`
...
`]}})}})]}function u(l={}){const{wrapper:n}={...i(),...l.components};return n?e(n,t(l,{get children(){return e(c,l)}})):c(l)}export{u as default};
