import{b as e,m as o,i as t,t as l}from"./web-DScAkgcG.js";import{M as a}from"./index-CYDpJFld.js";import{O as s}from"./install-DXNdm3rz.js";import"./clipboard-DNY8yvE8.js";var c=l("<strong>Mono"),h=l("<strong>Example : "),d=l("<s>JetbrainsMono Nerd Font Mono"),m=l("<strong>(OPTIONAL)");function i(r){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...r.components};return[e(n.h2,{children:"Pre-requisites"}),`
...
`,e(s,{}),`
`,e(n.h3,{children:"Non Interactive"}),`
`,e(n.ul,{get children(){return[`
`,e(n.li,{children:"Clone the repo to the nvim config path."}),`
`,e(n.li,{get children(){return["Setup the environment variable ",e(n.code,{children:"NVCHAD_EXAMPLE_CONFIG"})," to ",e(n.code,{children:"n or y"}),"  Example:"]}}),`
`]}}),`
`,e(n.pre,{get children(){return e(n.code,{className:"hljs language-bash",get children(){return["NVCHAD_EXAMPLE_CONFIG=y nvim --headless ",e(n.span,{className:"hljs-string",children:'"+q"'}),`
`]}})}}),`
