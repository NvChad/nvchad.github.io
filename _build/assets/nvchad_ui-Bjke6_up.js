import{b as n,m as t,i as s,t as c}from"./web-DScAkgcG.js";import{M as i}from"./index-CYDpJFld.js";var a=c("<br>");function r(l){const e={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i(),...l.components};return[n(e.h2,{children:"Statusline & tabufline"}),`
...
`]}})}}),`
`,s(a),`
`,n(e.p,{get children(){return["Again, check the list of modules in ",n(e.a,{href:"https://github.com/NvChad/ui/blob/v2.0/lua/nvchad/tabufline",children:"our tabufline modules file"}),"."]}})]}function o(l={}){const{wrapper:e}={...i(),...l.components};return e?n(e,t(l,{get children(){return n(r,l)}})):r(l)}export{o as default};
