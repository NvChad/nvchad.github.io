import{M as i}from"./index-yHsRVhWw.js";import{b as n,q as h}from"./web-DqPol8Cv.js";const a={title:"NvChad Faq ",desc:"NvChad Common Faqs"};function t(r){const e={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...i(),...r.components};return[n(e.h2,{children:"Icons not working"}),`
...
`,n(e.ul,{get children(){return[`
`,n(e.li,{get children(){return["To make a custom local theme that's the base46 format, you have to create ",n(e.code,{children:"/lua/themes/mytheme.lua"}),". Check ",n(e.a,{href:"https://github.com/NvChad/base46/blob/v3.0/README.md",children:"base46 docs"})," for more info."]}}),`
`]}}),`
...
`]}}),`
`,n(e.h2,{children:"Syntax highlighting not working"}),`
`,n(e.ul,{get children(){return[`
`,n(e.li,{get children(){return["Make sure you have installed the treesitter parser for the language i.e ",n(e.code,{children:"TSInstall lua"}),"."]}}),`
`]}}),`
...
`]}})}})]}function c(r={}){const{wrapper:e}={...i(),...r.components};return e?n(e,h(r,{get children(){return n(t,r)}})):t(r)}export{c as default,a as meta};
