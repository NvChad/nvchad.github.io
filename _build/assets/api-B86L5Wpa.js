import{b as n,q as a,k as i,t}from"./web-uzQsy4d_.js";import{M as r}from"./index-BosUlz4E.js";var c=t("<kbd>Alt+1");const u={title:"NvChad Api",desc:"NvChad api functions doc"};function l(s){const e={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...r(),...s.components};return[n(e.h1,{children:"NvChad API"}),`
...
`]}})}})]}function m(s={}){const{wrapper:e}={...r(),...s.components};return e?n(e,a(s,{get children(){return n(l,s)}})):l(s)}export{m as default,u as meta};
