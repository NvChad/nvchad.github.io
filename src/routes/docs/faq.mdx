...
- To make a custom local theme thats of the base46 format, you have to create `/custom/themes/mytheme.lua`. Check [base46 docs](https://github.com/NvChad/base46/blob/v2.0/README.md) for more info.
