...
- To make a custom local theme that's the base46 format, you have to create `/lua/themes/mytheme.lua`. Check [base46 docs](https://github.com/NvChad/base46/blob/v3.0/README.md) for more info.
