...
- For customization, you should **read carefully** the default sets of options in the [nvconfig.lua](https://github.com/NvChad/NvChad/blob/v2.5/lua/nvconfig.lua#L21), then you can get started by checking the source code of [statusline modules](https://github.com/NvChad/ui/blob/v2.5/lua/nvchad/stl/utils.lua). Finally, taking a look at [ui repo](https://github.com/NvChad/ui/tree/v2.5/lua/nvchad) if you want further customization. 
